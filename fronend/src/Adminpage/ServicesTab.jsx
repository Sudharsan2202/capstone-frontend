...
const ServicesTab = () => {
  ...
  const handleUpdate = async () => {
    try {
      await axios.put(`https://cleanease-be.onrender.com/api/cleaningservices/${selectedService._id}`, updatedService,{
        headers: {
            Authorization: `Bearer ${user.token}`, // Include the token in the request headers
        },
    });
  ...
  const handleDelete = async (serviceId) => {
    try {
      await axios.delete(`https://cleanease-be.onrender.com/api/cleaningservices/${serviceId}`,{
        headers: {
            Authorization: `Bearer ${user.token}`, // Include the token in the request headers
        },
    });
