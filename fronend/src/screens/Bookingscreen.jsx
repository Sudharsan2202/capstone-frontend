...
const Bookingscreen = () => {
  ...
  return (
    <div className="container mt-5" style={{ backgroundImage: 
                ...
                <div className="col-md-12" style={{ textAlign: 'right' }}>
                  {isLoggedIn && selectedDate ? (
                    ...
                    <StripeCheckout
                      ...
                      currency='INR'
                      stripeKey=
                      "pk_test_51PWDI9091FBqVyDP4rokrIRRmgSK2CTctUvvMI4DRuVWvjUd4MwgnJW6C42NbqEgjmc4WRNeeVxeKEzbtTg6iENS00jHMYxYMM"
                    />
                  ) : (
