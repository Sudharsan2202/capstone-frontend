  ...
  return (
    <section className="py-3 py-md-5 py-xl-8">
      <div className="container" style={{ 
        backgroundImage: 
        `url(https://cdn.dribbble.com/userupload/10455062/file/original-3a22add8e67b37968d34b4ce95f3d5a3.png?resize=400x300&vertical=center)`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <div className="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
          <div className="col-12 col-lg-10 col-xl-5 animate__animated animate__fadeInLeft">
            <img className="img-fluid rounded mx-5" loading="lazy" src="https://t3.ftcdn.net/jpg/02/68/92/26/240_F_268922689_zQhWvpoJolEGBhanboirtjNzVycpheJW.jpg" alt="Cleaning Services" />
          </div>
          <div className="col-12 col-lg-6 col-xl-7 animate__animated animate__fadeInRight">
            <div className="row justify-content-xl-center">
              <div className="col-12 col-xl-11">
                ...
                the Clean Company has been providing safe, on-budget, on-time, and cost-effective cleaning solutions for our clients for over 25 years.
                Customer Service is at the epicenter of our business. Regardless of the size of your company or the scale of your project, you will reap the benefits of our devotion, experience and training.</p>
