     ...
     backgroundSize: 'cover', backgroundPosition: 'center' }}>
      ...
      <div className="row mt-5 animate__animated animate__fadeIn">
        <div className="col-md-6">
          ...
          <p><strong>salem Office:</strong><br />1816 Bimini Drive,<br />Tamil naud-10 , </p>
